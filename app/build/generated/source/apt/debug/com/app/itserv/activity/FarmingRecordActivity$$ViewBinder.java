...
public class FarmingRecordActivity$$ViewBinder<T extends FarmingRecordActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FarmingRecordActivity> implements Unbinder {
    private T target;
