...
public class ProtocolActivity$$ViewBinder<T extends ProtocolActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131690571, "field 'tvProtocol'");
    target.tvProtocol = finder.castView(view, 2131690571, "field 'tvProtocol'");
    return unbinder;
  }
  ...
  protected static class InnerUnbinder<T extends ProtocolActivity> implements Unbinder {
    private T target;
