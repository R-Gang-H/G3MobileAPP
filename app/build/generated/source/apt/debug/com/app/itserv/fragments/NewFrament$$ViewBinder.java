...
public class NewFrament$$ViewBinder<T extends NewFrament> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends NewFrament> implements Unbinder {
    private T target;
