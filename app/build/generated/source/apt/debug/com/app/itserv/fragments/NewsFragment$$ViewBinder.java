...
public class NewsFragment$$ViewBinder<T extends NewsFragment> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131689701, "field 'xlistView'");
    target.xlistView = finder.castView(view, 2131689701, "field 'xlistView'");
  ...
  protected static class InnerUnbinder<T extends NewsFragment> implements Unbinder {
    private T target;
