...
public class AlarmPlanSettingActivity extends BaseActivity implements
        OnClickListener {
    ...
    private AlarmPlanSettingBean getSettingAlarm() {
        ...
        //log.v("psa_et1-" + psa_et1 + "psa_et2-" + psa_et2 + "psa_et3-"
        //	+ psa_et3);
        // 空气温度
                            ...
                            public void onFocusChange(View v, boolean hasFocus) {
                                if (hasFocus) {// 获得焦点
                                    ...
                                    String edittext2 = editText2.getText()
                                            .toString();
                                    if (edittext2 != null && !edittext1.equals("") && !edittext2.equals("")) {
                        ...
                        .setOnFocusChangeListener(new View.OnFocusChangeListener() {
                            ...
                            public void onFocusChange(View v, boolean hasFocus) {
                                if (hasFocus) {// 获得焦点
                                    ...
                                    String edittext1 = editText2.getText()
                                            .toString();
                                    String edittext2 = editText3.getText()
                                            .toString();
                                    if (edittext2 != null && !edittext1.equals("") && !edittext2.equals("")) {
                                        int parseIntstring = Integer
                                                .parseInt(edittext1);
    ...
    private void initChangeListener() {
        // 电池
        setCheckedlistener(air_psa_ch1, air_psa_ch2, air_psa_et2);
        setCheckedlistener(air_psa_ch2, air_psa_ch3, air_psa_et3);
        // 空气温度
        setCheckedlistener(air_temp_h_ch1, air_temp_h_ch2, air_temp_h_ed2);
        setCheckedlistener(air_temp_h_ch2, air_temp_h_ch3, air_temp_h_ed3);
        setCheckedlistener(air_temp_l_ch1, air_temp_l_ch2, air_temp_l_ed2);
        setCheckedlistener(air_temp_l_ch2, air_temp_l_ch3, air_temp_l_ed3);
        // 空气湿度
        setCheckedlistener(air_humid_h_ch1, air_humid_h_ch2, air_humid_h_ed2);
        setCheckedlistener(air_humid_h_ch2, air_humid_h_ch3, air_humid_h_ed3);
        setCheckedlistener(air_humid_l_ch1, air_humid_l_ch2, air_humid_l_ed2);
        setCheckedlistener(air_humid_l_ch2, air_humid_l_ch3, air_humid_l_ed3);
        // 土壤温度
        setCheckedlistener(air_soil_temp_h_ch1, air_soil_temp_h_ch2,
                air_soil_temp_h_ed2);
        setCheckedlistener(air_soil_temp_h_ch2, air_soil_temp_h_ch3,
                air_soil_temp_h_ed3);
        setCheckedlistener(air_soil_temp_l_ch1, air_soil_temp_l_ch2,
                air_soil_temp_l_ed2);
        setCheckedlistener(air_soil_temp_l_ch2, air_soil_temp_l_ch3,
                air_soil_temp_l_ed3);
        // 土壤湿度
        setCheckedlistener(air_soil_humid_h_ch1, air_soil_humid_h_ch2,
                air_soil_humid_h_ed2);
        setCheckedlistener(air_soil_humid_h_ch2, air_soil_humid_h_ch3,
                air_soil_humid_h_ed3);
        setCheckedlistener(air_soil_humid_l_ch1, air_soil_humid_l_ch2,
                air_soil_humid_l_ed2);
        setCheckedlistener(air_soil_humid_l_ch2, air_soil_humid_l_ch3,
                air_soil_humid_l_ed3);
        // 光照
        setCheckedlistener(air_lux_h_ch1, air_lux_h_ch2, air_lux_h_ed2);
        setCheckedlistener(air_lux_h_ch2, air_lux_h_ch3, air_lux_h_ed3);
        setCheckedlistener(air_lux_l_ch1, air_lux_l_ch2, air_lux_l_ed2);
        setCheckedlistener(air_lux_l_ch2, air_lux_l_ch3, air_lux_l_ed3);
        // co
        setCheckedlistener(air_co_h_ch1, air_co_h_ch2, air_co_h_ed2);
        setCheckedlistener(air_co_h_ch2, air_co_h_ch3, air_co_h_ed3);
        setCheckedlistener(air_co_l_ch1, air_co_l_ch2, air_co_l_ed2);
        setCheckedlistener(air_co_l_ch2, air_co_l_ch3, air_co_l_ed3);
        // co2
        setCheckedlistener(air_co2_h_ch1, air_co2_h_ch2, air_co2_h_ed2);
        setCheckedlistener(air_co2_h_ch2, air_co2_h_ch3, air_co2_h_ed3);
        setCheckedlistener(air_co2_l_ch1, air_co2_l_ch2, air_co2_l_ed2);
        setCheckedlistener(air_co2_l_ch2, air_co2_l_ch3, air_co2_l_ed3);

        // 烟雾
        setCheckedlistener(air_smoke_h_ch1, air_smoke_h_ch2, air_smoke_h_ed2);
        setCheckedlistener(air_smoke_h_ch2, air_smoke_h_ch3, air_smoke_h_ed3);

    }

    /**
     * @param air_psa_ch 需要监听的 CheckBox
     * @param
     * @param air_psa_et 需要改变的可编辑的 EditText
     */
    private void setCheckedlistener(CheckBox air_psa_ch,
                                    final CheckBox air_psa_ch2, final EditText air_psa_et) {
        air_psa_ch
                .setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView,
                        ...
                        // TODO Auto-generated method stub
                        if (isChecked) {
                            air_psa_ch2.setEnabled(true);
                            air_psa_et.setEnabled(true);

                        } else {
                            air_psa_ch2.setChecked(false);
                            air_psa_ch2.setEnabled(false);
                            air_psa_et.setEnabled(false);
                        }
                    }
                });
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_plan_submit:
                btnPlanSubmit.setFocusable(true);
                ...
                TextView tv_deldialog_content = (TextView) fragmentSetshedDeldialog
                        .findViewById(R.id.tv_deldialog_content);
                tv_deldialog_content.setText("是否添加<" + strategy_name + ">策略?");
                // 确认
                btnEnsure.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        new addAlarmSetting().execute(json);
    ...
    private String checkout_h(Integer h_value_y, Integer h_value_o,
        ...
        if (h_value_y != null && h_value_o != null) {
            if (h_value_o <= h_value_y) {
                editText2.setText("");
                ToastUtils.makeTextShort(conige + "值设置错误请重新设置!");
    ...
    private class addAlarmSetting extends AsyncTask<Object, Void, String> {

        @Override
        protected String doInBackground(Object... arg0) {
            String json = (String) arg0[0];
            String staString = "";
            String result = WapiUtil.addCustomAlarmStrategies(json);
            // log.v(result);
            ...
            try {
                ...
                if (addState.equals("OK")) {
                    ...
                    bundle.putSerializable("strategy", mAlarmStrategy);
                    mIntent.putExtras(bundle);
                    setResult(Constants.RESULT_SUCCESS, mIntent);
                    finish();
                } else {
                    staString = "添加策略失败";
                }
    ...
    private void check_h(CheckBox checkBox1, CheckBox checkBox2,
        ...
        assert ed2 != null;
        if (!ed2.equals("") && !(ed3 != null ? ed3.equals("") : false)) {
