 ...
 */
public class MyFarmingRecordActivity extends BaseActivity implements OnClickListener,
        OnItemClickListener {
    ...
    //记录列表
    private List<JsonFarmingRecordObject.ObjBean> objBeans = null;
    ...
    // 所属大棚
    private List<JsonbelongGreenHouseOBject.ObjBean> greenhouseBeans = new ArrayList<JsonbelongGreenHouseOBject.ObjBean>();
    private BelongGreenHoustAdapter belongGreenHoustAdapter;
    private JsonbelongGreenHouseOBject.ObjBean greenhouseBean;
    // 任务名称
    private List<JsonBelongTaskNameObject.ObjBean> tasknameBeans = new ArrayList<JsonBelongTaskNameObject.ObjBean>();
            ...
            public void onSuccess(JsonbelongGreenHouseOBject jsonHouseObject) {
                if (jsonHouseObject != null) {
                    if (jsonHouseObject.isSuccess()) {// 成功
                        ...
                        Log.i("11111111111ghouseId:", ghouseId + "");
    ...
    private void setFramingRecordUrl() {
        ...
        HttpManager.getInstance().apiFramingRecordGetList(TAG, token, currTenantId, currUserId, ghouseId, taskId, farmingCategory, createBy, createDateStart + " 00:00:00", createDateEnd + " 23:59:59", new HttpCallBack<JsonFarmingRecordObject>() {
            @Override
            public void onSuccess(final JsonFarmingRecordObject jsonFarmingRecordObject) {
                if (jsonFarmingRecordObject != null) {
                    if (jsonFarmingRecordObject.isSuccess()) {// 成功
                        JsonFarmingRecordObject.AttributesBean attributesbean = jsonFarmingRecordObject.getAttributes();
    ...
    private void initView() {
        ...
        greenhouse.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                String ghouseIdname = greenhouseBeans.get(position)
                        .getGhouseFullname();
                Log.i(TAG, "所属大棚  选择监听  名字：" + ghouseIdname
                        + "        编号：" + ghouseId);
                if (!TextUtils.isEmpty(ghouseId)) {
                    setBelongRecorder();
                }
        ...
        taskname.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                String tasknameString = tasknameBeans.get(position)
                        .getTaskName();
                Log.i("qqqq点击了qqqqqq", "任务名称 选择监听  名字：" + tasknameString
                        + "任务ID：" + taskId);
            }
        ...
        fartype.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.i("qqqq点击了qqqqqq", "农事分类 选择监听 名字：" + strnameString
        ...
        recorder.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.i("qqqq点击了qqqqqq", "记录人  选择监听：" + createBy);
            }
