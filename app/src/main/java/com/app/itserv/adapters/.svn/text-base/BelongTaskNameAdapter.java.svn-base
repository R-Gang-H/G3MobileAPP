...
import com.app.itserv.jparser.JsonBelongTaskNameObject.ObjBean;
...
public class BelongTaskNameAdapter extends BaseAdapter {
    private Context mContext;
    private List<ObjBean> objBeans;
    private ViewHolder holder;


    public BelongTaskNameAdapter(Context mContext, List<ObjBean> objBeans) {
        super();
