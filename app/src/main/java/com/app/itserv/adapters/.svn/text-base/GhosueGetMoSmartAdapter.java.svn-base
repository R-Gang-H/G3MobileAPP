...
import com.app.itserv.jparser.JsonGreenHouseGatMoSmartObject.ObjBean;
...
public class GhosueGetMoSmartAdapter extends BaseAdapter {

    private List<ObjBean> objBeans;
    private Context mContext;
    private ViewHolder holder;

    public GhosueGetMoSmartAdapter(Context mContext, List<ObjBean> gHouseObjList) {
        super();
        this.mContext = mContext;
        this.objBeans = gHouseObjList;
    }
public void setListobjBeans(List<ObjBean> objBeans){
...
//          holder.tvname.setBackgroundColor(Color.parseColor("#50960a"));
        ...
        holder.tvname.setText(TextUtils.isEmpty(objBeans.get(position)
                .getDev_name()) ? "" : objBeans.get(position)
                .getDev_name());
        return convertView;
    }
