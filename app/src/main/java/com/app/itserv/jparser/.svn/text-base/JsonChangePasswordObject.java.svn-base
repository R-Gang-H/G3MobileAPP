...
/**
 * @project name：yyshed
 * @type name：JsonChangePasswordObject
 * @description：修改密码json报文解析类
 * @author：gang
 * @date time：2017-6-3 下午4:16:05
 * @version
 */

/**
 * attributes : {"orgId":null,"orgNum":1}
...
public class JsonChangePasswordObject {
